...
class OtherUserProfile2 extends StatefulWidget {
  ...
  @override
  _OtherUserProfile2State createState() => _OtherUserProfile2State();
}
...
class _OtherUserProfile2State extends State<OtherUserProfile2> {
  ...
  Future<void> didChangeDependencies() async {
    ...
    if (followingList.contains(searchedUsers[0].userUid)) {
      setState(() {
        following = true;
                    ...
                    : following
                        ? MaterialButton(
                            ...
                            onPressed: () async {
                              ...
                              await unFollowUser(searchedUsers);
                              setState(() {
                                following = false;
                        ...
                        : MaterialButton(
                            ...
                            onPressed: () async {
                              ...
                              await followUser(searchedUsers);
                              setState(() {
                                following = true;
                                _buttonisLoading = false;
                              });
